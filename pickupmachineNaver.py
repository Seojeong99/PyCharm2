...
def naver(korean, English):
    ...
    driver.get(URL1)
    time.sleep(5)
   # driver.find_element_by_css_selector('//*[@id="txtSource"]').clear()
    time.sleep(3)
    driver.find_element_by_css_selector('//*[@id="txtSource"]').send_keys(korean)
    time.sleep(7)
    ...
    time.sleep(7)
    soup = BeautifulSoup(driver.page_source, "html.parser")
    googlekorea = soup.find('span').text
    ...
    time.sleep(7)
    soup = BeautifulSoup(driver.page_source, "html.parser")
    googlekorea2 = soup.find('span').text
