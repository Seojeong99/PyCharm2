...
def google(korean, English):
    ...
    URL1 = "https://translate.google.com/?sl=ko&tl=de&op=translate"
    driver.get(URL1)
    time.sleep(4)
    ...
    URL2 = "https://translate.google.com/?sl=de&tl=ko&op=translate"
    driver.get(URL2)
    time.sleep(4)
    ...
    URL3 = "https://translate.google.com/?sl=de&tl=ko&op=translate"
    driver.get(URL3)
    time.sleep(4)
...
def naver(korean, English):
    ...
    URL1 = "https://papago.naver.com/?sk=ko&tk=de"
    driver.get(URL1)
    time.sleep(6)
    ...
    if result == English:
        ...
        # <google tanslate 한글> == <original 한글>
    time.sleep(3)
    URL2 = "https://papago.naver.com/?sk=de&tk=ko"
    driver.get(URL2)
    time.sleep(4)
    ...
    URL3 = "https://papago.naver.com/?sk=de&tk=ko"
    driver.get(URL3)
    time.sleep(4)
...
def kakao(korean, English):
    ...
    time.sleep(4)
    driver.find_element_by_xpath("/html/body/div[1]/div[2]/div/div[1]/div[1]/div[1]/div[1]/div/ul/li[7]/a").click()
    time.sleep(4)
    driver.find_element_by_xpath('//*[@id="query"]').click()
    time.sleep(4)
