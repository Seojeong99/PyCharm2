...
def naver(korean, English):
    ...
    URL1 = "https://papago.naver.com/?sk=ko&tk=ru"
    driver.get(URL1)
    time.sleep(5)
    ...
    if result == English:
        ...
        # <google tanslate 한글> == <original 한글>
    time.sleep(2)
    URL2 = "https://papago.naver.com/?sk=ru&tk=ko"
    driver.get(URL2)
    time.sleep(3)
    ...
    URL3 = "https://papago.naver.com/?sk=ru&tk=ko"
    driver.get(URL3)
    time.sleep(3)
...
def kakao(korean, English):
    ...
    time.sleep(3)
    driver.find_element_by_xpath('/html/body/div[1]/div[2]/div/div[1]/div[1]/div[1]/div[2]/div/ul/li[7]/a').click()
    time.sleep(5)
    soup = BeautifulSoup(driver.page_source, "html.parser")
    ...
    time.sleep(3)
    driver.find_element_by_xpath("/html/body/div[1]/div[2]/div/div[1]/div[1]/div[1]/div[1]/div/ul/li[8]/a").click()
    time.sleep(3)
    driver.find_element_by_xpath('//*[@id="query"]').click()
    time.sleep(3)
